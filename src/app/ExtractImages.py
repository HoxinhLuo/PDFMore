...
class ExtractImages(UiExtractImages, DndDrop):
    ...
    def _set_options(self):
        if self._page_count > 0:
            ...
            self.app_info.set(f'Total Pages: {format(self._page_count)}')
    ...
    def set_images_dir(self):
        ...
        self._images_dir = askdirectory(title='Select images folder')
        if self._images_dir:
